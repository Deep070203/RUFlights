...
<head style="background-color: #cc0033">
    <meta charset="UTF-8">
...
<body style="background-color: #cc0033">
    <nav class="w-100pc flex flex-column md-flex-row md-px-10 py-5" style="background-color: #cc0033">
        <div class="flex justify-between">
            <a href="#" class="flex items-center p-2 mr-4 no-underline">
                <img class="max-h-l2 w-auto" src="images/Rutgers_Flights.png" width="1200" height="200" />
            </a>
