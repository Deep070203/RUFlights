		...
		try {
			...
			String str0 = 
				...
				//out.print("Works up to checkpoint:2.5 ");
					...
					out.print("</tr>");
					//out.print("Works up to checkpoint:2.8 ");
					//reset the pointers of the resultsets
					flightsAB.beforeFirst(); 
		
				 
					//out.print("Works up to checkpoint:2.9 ");
				
			
					while(flightsAB.next()){
						//out.print("Works up to checkpoint:4.4 ");

						{
								out.print("CON ALTURA");
								out.print("<tr>");
								out.print("<td>");
								...
								out.print("</tr>");
								out.print("<tr>");
								//out.print("Works up to checkpoint:4.5 ");
				 ...
				 //out.print("Works up to checkpoint:5 ");
