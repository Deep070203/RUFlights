	...
	<%
		try {
			...
			if (filterOp.equals("By Customer")) {
				...
				out.print("</table>");
				String str1 = "SELECT user_name FROM users GROUP BY user_name ORDER BY MAX(profits) DESC LIMIT 1";
				PreparedStatement stmt1 = con.prepareStatement(str1);
				ResultSet flights1 = stmt1.executeQuery();

				if (flights1.next()) {
				    out.print("<p>Customer who generated the most revenue: <strong>" + flights1.getString("user_name") + "</strong></p>");
				} else {
