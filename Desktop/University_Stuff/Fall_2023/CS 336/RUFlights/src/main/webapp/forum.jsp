...
<body>
	<button style="margin: 0 auto;"
			onclick="window.location.href = 'question.jsp'">ASK A QUESTION
	</button>
	<%
		try {
		...
		if (request.getMethod().equalsIgnoreCase("post")) {
                    ...
                    String insertQuery = "INSERT INTO forum (questions, answers) VALUES (?, '')";
	...
	%>
			<button style="margin: 0 auto;"
				onclick="window.location.href = 'customerLandingPage.jsp'">GO BACK
			</button>
	<script>
		function myFunction() {
		  // Declare variables
